...
const float magn_ellipsoid_center[3] = {59.5654, 72.9969, 16.3862};
const float magn_ellipsoid_transform[3][3] = {{0.952219, -0.0205664, -5.90336e-06}, {-0.0205664, 0.955430, 0.0294759}, {-5.90336e-06, 0.0294759, 0.975671}};
